...
<div class="wrapper">
                ...
                <div class="sidebar-content">
                    <div class="nav-container">
                        <nav id="main-menu-navigation" class="navigation-main">
                            ...
                            <div class="nav-item">
                                <a href="/machinery"><i class="ik ik-box"></i><span>Machinery</span></a>
                            </div>
                        </nav>
                    </div>
                </div>
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                ...
                                                <div id="data_table_filter"
                                                    ...
                                                    <button data-toggle="modal" data-target="#demoModaladdnew"
                                                        ...
                                                        data-dismiss="modal">Add New Seed</button>
                                                                    ...
                                                                    <div class="table-actions">
                                                                        <!-- <a href="#" data-toggle="modal"
                                                                            data-target="#demoModal"><i
                                                                                class="ik ik-eye"></i></a> -->
                                                                        <a href="/seed/{{$resource->id}}/edit"><i class="ik ik-edit-2"></i></a>
                                                                        {!!Form::open(['action' => ['SeedController@destroy', $resource->id], 'method' => 'POST', 'class' => 'pull-right'])!!}
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="demoModalLabel">Seeds Detail</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                aria-hidden="true">&times;</span></button>
                    </div>
                    <div class="modal-body">
                        <form action="{{ action('SeedController@store') }}" method="post" class="form-sample">
        ...
        <div class="modal fade" id="demoModaladdnew" tabindex="-1" role="dialog" aria-labelledby="demoModaladdnewLabel"
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="demoModalLabel">Add New Seed Detail</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                aria-hidden="true">&times;</span></button>
                    </div>
                    <div class="modal-body">
