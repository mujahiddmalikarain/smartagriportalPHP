            ...
            <div class="main-content">
                <div class="container-fluid">
                        ...
                        <div class="row align-items-end">
                            <div class="col-lg-8">
                                <div class="page-header-title">
                                    ...
                                    <div class="d-inline">
                                        <h5>Resources | Machinery | Update</h5>
                    ...
                    <div class="row">
                        ...
                        {!! Form::open(['action' => ['MachineryController@update', $machinery->id ], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                        <input name="_token" type="hidden" value="{{ csrf_token() }}"/>  
                            <div class="form-group row">
                                <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Machinery  Name</label>
                                <div class="col-sm-9">
                                    <input type="text" name="name" value="{{$machinery->name}}" class="form-control" id="exampleInputFertilizerName2"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="description"  value="{{$machinery->description}}" class="form-control" id="exampleInputDescription2"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="date" name="exp_date" value="{{$machinery->exp_date}}"  class="form-control" placeholder="Expiry Date">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="exampleInputPassword2" class="col-sm-3 col-form-label">Prise(Rs)</label>
                                <div class="col-sm-9">
                                    <input type="number" name="price"  value="{{$machinery->price}}" class="form-control" placeholder="Prise(Rs)">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="exampleSelectGender" class="col-sm-3 col-form-label">Status (Current Status: {{$machinery->status}})</label>
                                <div class="col-sm-9">
