            ...
            <div class="main-content">
                <div class="container-fluid">
                        ...
                        <div class="row align-items-end">
                            <div class="col-lg-8">
                                <div class="page-header-title">
                                    ...
                                    <div class="d-inline">
                                        <h5>Resources | Fertilizer | Update</h5>
                    ...
                    <div class="row">
                        ...
                        {!! Form::open(['action' => ['FertilizerController@update', $fertilizer->id ], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                        <input name="_token" type="hidden" value="{{ csrf_token() }}"/>  
                            <div class="form-group row">
                                <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Fertilizer Name</label>
                                <div class="col-sm-9">
                                    <input type="text" name="name" value="{{$fertilizer->name}}" class="form-control" id="exampleInputFertilizerName2"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="description"  value="{{$fertilizer->description}}" class="form-control" id="exampleInputDescription2"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="date" name="exp_date" value="{{$fertilizer->exp_date}}"  class="form-control" placeholder="Expiry Date">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="exampleInputPassword2" class="col-sm-3 col-form-label">Prise(Rs)</label>
                                <div class="col-sm-9">
                                    <input type="number" name="price"  value="{{$fertilizer->price}}" class="form-control" placeholder="Prise(Rs)">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="exampleSelectGender" class="col-sm-3 col-form-label">Status (Current Status: {{$fertilizer->status}})</label>
                                <div class="col-sm-9">
