...
<div class="wrapper">
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                ...
                                                <div id="data_table_filter"
                                                    ...
                                                    <button data-toggle="modal" data-target="#demoModaladdnew"
                                                        ...
                                                        data-dismiss="modal">Add New Fertilizer</button>
                                                                    ...
                                                                    <div class="table-actions">
                                                                        <!-- <a href="#" data-toggle="modal"
                                                                            data-target="#demoModal"><i
                                                                                class="ik ik-eye"></i></a> -->
                                                                        <a href="/fertilizer/{{$resource->id}}/edit"><i class="ik ik-edit-2"></i></a>
                                                                        {!!Form::open(['action' => ['FertilizerController@destroy', $resource->id], 'method' => 'POST', 'class' => 'pull-right'])!!}
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="demoModalLabel">Fertilizers Detail</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                aria-hidden="true">&times;</span></button>
                    </div>
                    <div class="modal-body">
                        <form action="{{ action('FertilizerController@store') }}" method="post" class="form-sample">
                        <input name="_token" type="hidden" value="{{ csrf_token() }}"/>  
 
                        <div class="form-group row">
                                <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Fertilizer Name</label>
                                <div class="col-sm-9">
                                    <input type="text" name="name" class="form-control" id="exampleInputFertilizerName2"
        ...
        <div class="modal fade" id="demoModaladdnew" tabindex="-1" role="dialog" aria-labelledby="demoModaladdnewLabel"
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="demoModalLabel">Add New Fertilizer Detail</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                aria-hidden="true">&times;</span></button>
                    </div>
                    <div class="modal-body">
