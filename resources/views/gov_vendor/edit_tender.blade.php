                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card table-card">
                                ...
                                <div class="col-md-8">
                                {!! Form::open(['action' => ['TenderController@update', $tender->id ], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                                ...
                                <input name="_token" type="hidden" value="{{ csrf_token() }}"/>  
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="title" value="{{$tender->about}}" class="form-control" id="exampleInputSeedName2"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="type" value="{{$tender->type}}" class="form-control" id="exampleInputSeedName2"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="description" value="{{$tender->description}}" class="form-control" id="exampleInputDescription2"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="date" name="date" value="{{$tender->last_date}}" class="form-control" placeholder="Deadline Date" required>
                                            </div>
                                        </div>
