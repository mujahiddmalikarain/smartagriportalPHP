        ...
        <div class="page-wrap">
            ...
            <div class="main-content">
                <div class="container-fluid">
                    ...
                    <div class="card">
                    <div class="card-body">
                    {!! Form::open(['action' => ['MvideosController@update', $mvideo->id ], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                    <input name="_token" type="hidden" value="{{ csrf_token() }}"/>
                                <div class="form-group row">
                                    <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Video
                                        Name</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="mvname" value="{{$mvideo->name}}" class="form-control" id="exampleInputSeedName2"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="mvdescription" value="{{$mvideo->description}}" class="form-control" id="exampleInputDescription2"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="url" class="form-control" name="mvurl" value="{{$mvideo->url}}" id="exampleInputDescription2"
                                            placeholder="Youtube Link" required="required">
                                    </div>
                                </div>
                                <div class="form-group row">
